...
import se331.project.projectTwoCompo.security.config.JwtService;
import se331.project.projectTwoCompo.security.token.Token;
import se331.project.projectTwoCompo.security.token.TokenRepository;
import se331.project.projectTwoCompo.security.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    User user = User.builder()
        ...
        .build();
    Student st = studentRepository.save(Student.builder()
    ...
    return AuthenticationResponse.builder()
        ...
        .user(LabMapper.INSTANCE.getPersonAuthDTO(savedUser.getUser()))
        .build();
  }
  ...
  public AuthenticationResponse authenticate(AuthenticationRequest request) {
    ...
    return AuthenticationResponse.builder()
        .accessToken(jwtToken)
        .refreshToken(refreshToken)
        .user(LabMapper.INSTANCE.getPersonAuthDTO(user.getUser()))
        .build();
  }
